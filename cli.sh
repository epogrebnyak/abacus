...
abacus chart -a cash,goods,ppe -e cogs,sga,rent,interest -c eq -re r -l dividend_due,loan -i sales -n sales discounts,cashback net_sales -n eq treasury_stock free_float -n ppe depreciation net_ppe
