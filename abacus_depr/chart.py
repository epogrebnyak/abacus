...
from abacus_depr.accounting_types import AbacusError, AccountName, Operation
from abacus_depr.accounts import Account as TAccount
from abacus_depr.accounts import IncomeSummaryAccount, RetainedEarnings, allocation
...
class QualifiedChart(BaseModel):
    ...
    def ledger(self):
        ...
        from abacus_depr.ledger import Ledger
    ...
    def book(self, starting_balances: dict | None = None):
        from abacus_depr.book import Book
