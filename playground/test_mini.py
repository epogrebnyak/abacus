...
def test_balance_sheet_respects_contra_account():
    ...
    chart.accounts.set(T5.Asset, "cash")
    chart.accounts.set(T5.Capital, "equity")
    chart.accounts.offset("equity", "treasury_shares")
...
def test_end_to_end():
    ...
    print(chart.accounts)
    chart.accounts.set(T5.Asset, "cash")
    chart.accounts.set(T5.Asset, "inventory")
    chart.accounts.set(T5.Capital, "equity")
    chart.accounts.set(T5.Expense, "cogs")
    chart.accounts.set(T5.Income, "sales")
    chart.accounts.offset("sales", "refunds")
